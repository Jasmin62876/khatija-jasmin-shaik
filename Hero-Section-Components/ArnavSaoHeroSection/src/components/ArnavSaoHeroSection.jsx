  ...
  return (
    <>
      ...
      <div className="relative bg-cover bg-center h-screen">
        ...
        {/* Content */}
        <div className="relative z-10 flex flex-col justify-center items-center text-center h-full text-black px-4 md:px-8 py-0">
          ...
          {/* Button */}
          <button className="bg-black hover:text-sky-200 text-white font-bold py-2 px-8 md:px-10 rounded shadow-lg transition duration-300 ease-in-out transform hover:scale-105 block md:inline-block md:ml-0 md:text-left"> {/* Adjusted padding and alignment for button */}
            Get Started
          </button>
        </div>
      </div>
